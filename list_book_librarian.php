...
<div>
    ...
    <table style="width:100%">
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href=\"edit_book_librarian.php?book_id=" . $row["id"] . "\">Edit</a> | <a href=\"delete_book.php?book_id=" . $row["id"] . "\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
        }
